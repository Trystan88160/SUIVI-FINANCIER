  ...
  <div style="background:var(--bg-card);border-radius:12px;padding:.85rem 1rem;border-left:3px solid var(--danger)">
    ...
    _tabCardsConfig: {
        'dashboard': [
            ...
            { id: 'dash-evol-repart', label: 'Évolution + Répartition', sub: 'Graphiques patrimoine & donut' },
        ...
        'depenses': [
            ...
            { id: 'dep-tripanel',    label: 'Comparaison / 50-30-20 / Récurrentes', sub: "Outils d'analyse" },
        ...
        'pea': [
            ...
            { id: 'pea-outils-btn', label: '🧮 Outils avancés',           sub: 'Retraite, Simulateur' },
        ...
        'patrimoine': [
            ...
            { id: 'pat-barre',     label: 'Barre de répartition',     sub: 'Liquidités vs investissements' },
